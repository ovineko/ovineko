...
- [ ] Read package.json, src/react/index.tsx for exports
- [ ] Extract lazyWithRetry example from test
- [ ] Create minimal README: description, install (with react peer dep), usage example, API exports, related packages, license
...
- [ ] Read package.json, src/index.tsx for exports
- [ ] Extract ErrorBoundaryReactRouter example from test
- [ ] Create minimal README: description, install (with react, react-router peer deps), usage example, related packages, license
- [ ] Keep under 150 lines
...
- [ ] Read package.json, src/index.ts for exports and options
- [ ] Extract plugin config example from test
- [ ] Create minimal README: description, install (with vite peer dep), usage example, options reference, related packages, license
- [ ] Keep under 150 lines
...
- [ ] Read package.json, src/index.ts for exports
- [ ] Extract createHtmlCache example from test
- [ ] Create minimal README: description, install (with parse5 peer dep), usage example, API exports, related packages, license
- [ ] Keep under 150 lines
...
- [ ] Read package.json, src/index.ts for exports
- [ ] Extract fastifySPAGuard plugin registration example from test
- [ ] Create minimal README: description, install (with fastify, fastify-plugin, spa-guard-node peer deps), usage example, related packages, license
- [ ] Keep under 150 lines
...
- [ ] Read package.json, src/index.ts for exports
- [ ] Extract recommended config example from test
- [ ] Create minimal README: description, install (with eslint peer dep), usage example showing both rules, related packages, license
- [ ] Keep under 150 lines
...
- [ ] Make package names in the table link to their README.md files (e.g., `[@ovineko/spa-guard](./spa-guard/spa-guard/README.md)`)
- [ ] Verify all 7 links are correct
