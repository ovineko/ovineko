---
title: Node.js (@ovineko/spa-guard-node)
sidebar_position: 6
---
...
- `translations` — built-in translation map (38 languages including en, ko, ja, zh, fr, de, es, pt, ru, ar, and more)

## Related packages

- [@ovineko/spa-guard](./core) — core runtime (install in your app entry)
- [@ovineko/spa-guard-vite](./vite) — Vite plugin that injects the runtime at build time
- [@ovineko/spa-guard-fastify](./fastify) — Fastify plugin built on this package
